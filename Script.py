...
🌿 𝐌𝐚𝐢𝐧𝐭𝐚𝐢𝐧𝐞𝐝 𝐁𝐲 : <a href='https://t.me/kinzanoufal'>𝐌𝐮𝐧𝐧𝐢𝐏𝐨𝐩𝐳</a></b>"""

    ABOUT_TXT = """<b>
‣ ᴍʏ ɴᴀᴍᴇ : {}
‣ ᴄʀᴇᴀᴛᴏʀ : <a href='tg://settings'>ᴛʜɪs ᴘᴇʀsᴏɴ​</a>
‣ ᴅᴇᴠᴇʟᴏᴘᴇʀ : <a href='https://t.me/kinzanoufal'>𝐌𝐮𝐧𝐧𝐢𝐏𝐨𝐩𝐳</a>
...
◆ ᴀʟʟ ᴄʀᴇᴅɪᴛs​: <a href='https://t.me/nasrani_admins'>𝐍𝐚𝐬𝐫𝐚𝐧𝐢</a></b>"""
...
┏🕵️ ᴀsᴋᴇᴅ ʙʏ:- {}
┣🔆 ᴘᴏᴡᴇʀᴇᴅ ʙʏ:- <a href='https://t.me/nasrani_update'>𝐊𝐢𝐧𝐳𝐚𝐧𝐨𝐮𝐟𝐚𝐥​</a> 
┗🗃 ᴛᴏᴛᴀʟ ꜰɪʟᴇs:-{}
...
📆 𝐑𝐞𝐥𝐞𝐚𝐬𝐞 𝐈𝐧𝐟𝐨 : <a href={url}/releaseinfo>{year}</a>

⏱️ 𝐑𝐞𝐬𝐮𝐥𝐭 𝐒𝐡𝐨𝐰𝐧 𝐢𝐧: {remaining_seconds} <i>seconds</i> 🔥

🌟 𝐑𝐚𝐭𝐢𝐧𝐠 :  <a href={url}/ratings>{rating}</a> / 10</b>"""     
...
{}
"""
    YT_TXT = """𝐇𝐞𝐥𝐥𝐨 {message.from_user.mention}\n
𝐌𝐀𝐃𝐄 𝐈𝐍 ›› [🎧𝐍𝐚𝐬𝐫𝐚𝐧𝐢_𝐔𝐩𝐝𝐚𝐭𝐞🎧](https://t.me/nasrani_update)\n𝐏𝐎𝐖𝐑𝐄𝐃 𝐁𝐘 ›› [𝐌𝐮𝐬𝐢𝐜](https://t.me/{temp.U_NAME})\n@NasraniSeries"""
